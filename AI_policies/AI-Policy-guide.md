...
**这是条件触发阶段，不是固定巡次。** 一旦满足高危条件，立即从当前阶段切换进入，不受巡次限制。
...
- 允许回退高收益低命中路线
- 必要时优先安全张、熟张、低放铳牌
- 允许“有胡不接”或主动放弃低收益捉冲，避免在高倍局继续扩大损失
...
**高回报听牌（自摸价值显著）的典型特征：**
- 门清 + 自摸潜在收益高（混一色10点、清一色、无花自摸等）
- 他家未形成极高压制
- 局面倍数高时，自摸价值被全局倍数进一步放大
- 此时应优先保门清、优先等更高收益张，允许为更大收益牺牲少量速度
...
- **无花自摸作为独立高收益项进入比较**：不要求所有局都做清一色才追自摸，混一色若可做成10点收益，自摸价值同等上调；若保门清、自摸、无花自摸路径同时成立，三者价值应显著上调
- 回报比高，优先保门清或大牌
- 回报比一般，且他家快，优先快速成型
- 回报比极低，且外部高危，优先防守和止损
...
- **先稳**：先恢复门清与基本结构能力，不乱拆、不乱吃碰
- **再准**：再学会中盘定向，不频繁换线，吃碰服务于锁定路线
- **再狠**：再学会冲刺期收益风险优化，在听牌质量、番数、速度间做清晰权衡
- **最后再贪**：最后才去追更复杂的高收益分支（五毒散、造反、大吊等）

这四个阶段的顺序不能颠倒。在“稳”还没做好之前，不要去追求“狠”和“贪”。
