...
import { L as buildAssetsURL, N as publicAssetsURL, u as useRuntimeConfig, O as getResponseStatusText, Q as getResponseStatus, R as encodePath, S as defineRenderHandler, g as getQuery, c as createError, V as destr, W as getRouteRules, j as joinURL, X as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, viewport-fit=cover"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"},{"name":"mobile-web-app-capable","content":"yes"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"长清阁麻将"};
