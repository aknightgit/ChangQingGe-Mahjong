...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ], "mahjong-page"])}" style="${ssrRenderStyle(mobileLayoutStyle.value)}" data-v-696dfd93><div class="${ssrRenderClass([{ "room-viewport--rotated": shouldRotateView.value }, "room-viewport"])}" data-v-696dfd93><div class="${ssrRenderClass([{ "room-container--rotated": shouldRotateView.value, "room-container--mobile-landscape": isMobileLandscapeMode.value }, "room-container"])}" data-v-696dfd93><header class="${ssrRenderClass([{ "room-header--collapsed": isTopBarCollapsed.value }, "room-header"])}" data-v-696dfd93><button class="${ssrRenderClass([{ "room-header-toggle--collapsed": isTopBarCollapsed.value }, "room-header-toggle"])}"${ssrRenderAttr("aria-expanded", String(!isTopBarCollapsed.value))}${ssrRenderAttr("title", isTopBarCollapsed.value ? "展开顶部栏" : "收起顶部栏")} data-v-696dfd93><span class="room-header-toggle__icon" data-v-696dfd93>${ssrInterpolate(isTopBarCollapsed.value ? "▼" : "▲")}</span><span class="room-header-toggle__label" data-v-696dfd93>${ssrInterpolate(isTopBarCollapsed.value ? "展开菜单" : "收起菜单")}</span></button><div class="room-header-content" style="${ssrRenderStyle(!isTopBarCollapsed.value ? null : { display: "none" })}" data-v-696dfd93><div class="room-info" data-v-696dfd93><div class="room-title-line" data-v-696dfd93><h1 class="mahjong-title" data-v-696dfd93>长清阁麻将</h1>`);
      if (unref(currentRound) > 0) {
        _push(`<span class="round-info-header" data-v-696dfd93>${ssrInterpolate(roundDisplay.value)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="header-actions" data-v-696dfd93><button class="mahjong-button small secondary" data-v-696dfd93> ⚙️ 设置 </button><button class="mahjong-button small secondary" data-v-696dfd93> 📖 规则 </button><button class="mahjong-button small" data-v-696dfd93> 返回大厅 </button></div></div></header><main class="room-main" data-v-696dfd93>`);
      if (!unref(gameState)) {
        _push(`<div class="loading-overlay" data-v-696dfd93><div class="loading-spinner" data-v-696dfd93></div><p class="loading-text" data-v-696dfd93>正在进入牌桌...</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showLiangShanOverlay.value) {
        _push(`<div class="liang-shan-overlay" data-v-696dfd93><div class="liang-shan-card" data-v-696dfd93><div class="liang-shan-icon" data-v-696dfd93>🔥🔥🔥</div><p class="liang-shan-title" data-v-696dfd93>聚义成功，共上梁山！</p><p class="liang-shan-sub" data-v-696dfd93>本局结束 · 下把翻倍</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(leadingBrotherEvent)) {
        _push(`<div class="leading-brother-overlay" data-v-696dfd93><div class="leading-brother-card" data-v-696dfd93><div class="lb-icon" data-v-696dfd93>🙏💰</div><p class="lb-title" data-v-696dfd93>谢谢带头大哥！</p><p class="lb-sub" data-v-696dfd93>${ssrInterpolate(unref(leadingBrotherEvent).firstPlayerName)} 连打同张，赔付三家各10分</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showApprovalOverlay.value && unref(actionApprovalEvent) && unref(actionApprovalEvent).candidatePlayerId === unref(currentPlayer)?.id) {
        _push(`<div class="approval-overlay" data-v-696dfd93><div class="approval-card" data-v-696dfd93><div class="approval-icon" data-v-696dfd93>⚡🀄</div><p class="approval-title" data-v-696dfd93>${ssrInterpolate(unref(actionApprovalEvent).requesterAction === "吃" ? "吃碰/胡冲突" : unref(actionApprovalEvent).requesterAction === "碰" ? "碰胡冲突" : "杠胡冲突")}！</p><p class="approval-sub" data-v-696dfd93>${ssrInterpolate(unref(actionApprovalEvent).requesterName)} 要${ssrInterpolate(unref(actionApprovalEvent).requesterAction)}这张牌</p><p class="approval-question" data-v-696dfd93>你要用${ssrInterpolate(unref(actionApprovalEvent).availableActions.map((a) => a === "hu" ? "胡" : a === "peng" ? "碰" : "杠").join("/"))}吗？</p><div class="${ssrRenderClass([{ "approval-countdown--urgent": approvalCountdownRatio.value < 0.3 }, "approval-countdown"])}" data-v-696dfd93><div class="approval-countdown-bar" style="${ssrRenderStyle({ width: `${approvalCountdownRatio.value * 100}%` })}" data-v-696dfd93></div><span class="approval-countdown-text" data-v-696dfd93>${ssrInterpolate(approvalCountdownSec.value)}s</span></div><div class="approval-buttons" data-v-696dfd93>`);
        if (unref(actionApprovalEvent).availableActions.includes("hu")) {
          _push(`<button class="approval-btn approval-btn--hu" data-v-696dfd93>胡！</button>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(actionApprovalEvent).availableActions.includes("kong")) {
          _push(`<button class="approval-btn approval-btn--kong" data-v-696dfd93>杠！</button>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(actionApprovalEvent).availableActions.includes("peng")) {
          _push(`<button class="approval-btn approval-btn--peng" data-v-696dfd93>碰！</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="approval-btn approval-btn--pass" data-v-696dfd93>算了，给他${ssrInterpolate(unref(actionApprovalEvent).requesterAction)}</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showApprovalOverlay.value && unref(actionApprovalEvent) && unref(actionApprovalEvent).candidatePlayerId !== unref(currentPlayer)?.id && isMyApprovalWaiting.value) {
        _push(`<div class="approval-waiting-overlay" data-v-696dfd93><div class="approval-waiting-card" data-v-696dfd93><div class="approval-waiting-icon" data-v-696dfd93>⏳</div><p class="approval-waiting-text" data-v-696dfd93>等待其他家做决定...</p><p class="approval-waiting-sub" data-v-696dfd93>你${ssrInterpolate(unref(actionApprovalEvent).requesterAction)}了这张牌，等待${ssrInterpolate(unref(actionApprovalEvent).availableActions.map((a) => a === "hu" ? "胡" : a === "peng" ? "碰" : "杠").join("/"))}</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (spectatorApprovalRequest.value) {
        _push(`<div class="approval-overlay" data-v-696dfd93><div class="approval-card" data-v-696dfd93><div class="approval-icon" data-v-696dfd93>👁️</div><p class="approval-title" data-v-696dfd93>观赛申请</p><p class="approval-sub" data-v-696dfd93>${ssrInterpolate(spectatorApprovalRequest.value.requesterName)} 想查看你的手牌</p><p class="approval-question" data-v-696dfd93>是否同意本局向 TA 开放你的观赛视角？</p><div class="approval-buttons" data-v-696dfd93><button class="approval-btn approval-btn--peng" data-v-696dfd93>同意</button><button class="approval-btn approval-btn--pass" data-v-696dfd93>拒绝</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showThinkOptions.value) {
        _push(`<div class="think-overlay" data-v-696dfd93><div class="think-card" data-v-696dfd93><div class="think-icon" data-v-696dfd93>🧠</div><p class="think-title" data-v-696dfd93>容我想一想</p><p class="think-sub" data-v-696dfd93>选择你的操作：</p><div class="think-options" data-v-696dfd93><!--[-->`);
        ssrRenderList(thinkOptions.value, (opt) => {
          _push(`<button class="${ssrRenderClass([opt.cssClass, "think-opt"])}" data-v-696dfd93>${ssrInterpolate(opt.label)}</button>`);
        });
        _push(`<!--]--></div></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (showChowPicker.value) {
        _push(`<div class="chow-picker-overlay" data-v-696dfd93><div class="chow-picker-card" data-v-696dfd93><h3 class="chow-picker-title" data-v-696dfd93>选择吃牌组合</h3><p class="chow-picker-sub" data-v-696dfd93>这张牌有多种吃法，请先选择组合。</p><div class="chow-picker-options" data-v-696dfd93><!--[-->`);
        ssrRenderList(chowOptions.value, (option, index) => {
          _push(`<button class="${ssrRenderClass([{ "chow-picker-option--selected": selectedChowOption.value === index }, "chow-picker-option"])}" data-v-696dfd93><div class="chow-picker-tiles" data-v-696dfd93><!--[-->`);
          ...
          _push(`<!--]--></div><span class="chow-picker-label" data-v-696dfd93>${ssrInterpolate(option.label)}</span></button>`);
        });
        _push(`<!--]--></div><div class="chow-picker-actions" data-v-696dfd93><button class="mahjong-button small secondary" data-v-696dfd93>取消</button><button class="mahjong-button small"${ssrIncludeBooleanAttr(selectedChowOption.value === null) ? " disabled" : ""} data-v-696dfd93>确认吃牌</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showHuPanel.value) {
        _push(`<div class="hu-panel-overlay" data-v-696dfd93><div class="hu-panel" data-v-696dfd93><h3 class="hu-panel-title" data-v-696dfd93>🀄 选择胡牌牌型</h3><div class="hu-combos" data-v-696dfd93><!--[-->`);
        ssrRenderList(activeHuOptions.value, (opt, idx) => {
          _push(`<div class="${ssrRenderClass([{ "hu-combo--selected": selectedHuCombo.value === idx }, "hu-combo"])}" data-v-696dfd93><div class="hu-combo-header" data-v-696dfd93><span class="hu-combo-rank" data-v-696dfd93>TOP ${ssrInterpolate(idx + 1)}</span><span class="hu-combo-label" data-v-696dfd93>${ssrInterpolate(opt.label.replace(/·自摸|·捉冲|\\\\(无百搭×2\\\\)/g, ""))}</span><span class="hu-combo-method" data-v-696dfd93>${ssrInterpolate(opt.type === "self_draw" ? "自摸" : "捉冲")}</span><span class="hu-combo-score" data-v-696dfd93>总赢 ${ssrInterpolate(getHuOptionTotalWin(opt))}</span></div><div class="hu-combo-formula" data-v-696dfd93>${ssrInterpolate(getHuOptionFormula(opt))}</div>`);
          if (formatHuOptionGroups(opt)) {
            _push(`<div class="hu-group-list" data-v-696dfd93><div class="hu-group" data-v-696dfd93><span class="hu-group-tiles-text" data-v-696dfd93>${ssrInterpolate(formatHuOptionGroups(opt))}</span></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="hu-summary-grid" data-v-696dfd93><div class="hu-summary-item" data-v-696dfd93><span class="hu-summary-key" data-v-696dfd93>基础番数/固定点数</span><span class="hu-summary-value" data-v-696dfd93>${ssrInterpolate(getHuOptionDisplaySummary(opt).base)}</span></div><div class="hu-summary-item" data-v-696dfd93><span class="hu-summary-key" data-v-696dfd93>额外倍数</span><span class="hu-summary-value" data-v-696dfd93>×${ssrInterpolate(getHuOptionDisplaySummary(opt).extra)}</span></div><div class="hu-summary-item" data-v-696dfd93><span class="hu-summary-key" data-v-696dfd93>全局倍数</span><span class="hu-summary-value" data-v-696dfd93>×${ssrInterpolate(getHuOptionDisplaySummary(opt).global)}</span></div><div class="hu-summary-item" data-v-696dfd93><span class="hu-summary-key" data-v-696dfd93>房间结算倍数</span><span class="hu-summary-value" data-v-696dfd93>×${ssrInterpolate(getHuOptionDisplaySummary(opt).settlement)}</span></div></div></div>`);
        });
        _push(`<!--]--></div><div class="hu-panel-actions" data-v-696dfd93>`);
        if (!isHuReviewMode.value) {
          _push(`<button class="hu-confirm-btn"${ssrIncludeBooleanAttr(selectedHuCombo.value === null) ? " disabled" : ""} data-v-696dfd93> 🀄 确认胡牌 </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="hu-cancel-btn" data-v-696dfd93>取消</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isOverlayVisible.value) {
        _push(`<div class="game-over-overlay" data-v-696dfd93><div class="${ssrRenderClass([{ "game-over-card--draw": isDrawOverlay.value }, "game-over-card"])}" data-v-696dfd93><p class="overlay-title" data-v-696dfd93>${ssrInterpolate(isDrawOverlay.value ? "流局！下把翻倍！" : overlayTitle.value)}</p><p class="overlay-message" data-v-696dfd93>${ssrInterpolate(overlayMessage.value)}</p>`);
        if (!isDrawOverlay.value && playerResults.value.length) {
          _push(`<ul class="overlay-results" data-v-696dfd93><!--[-->`);
          ssrRenderList(playerResults.value, (player) => {
            _push(`<li class="overlay-result-item" data-v-696dfd93><div data-v-696dfd93><span class="${ssrRenderClass([{ "rank-winner": player.isWinner }, "result-rank"])}" data-v-696dfd93>${ssrInterpolate(player.rankLabel)}</span><span class="result-name" data-v-696dfd93>${ssrInterpolate(player.name)}</span></div><div class="result-meta" data-v-696dfd93><span class="${ssrRenderClass([player.scoreClass, "result-score"])}" data-v-696dfd93>${ssrInterpolate(player.scoreLabel)}</span><span class="result-status" data-v-696dfd93>${ssrInterpolate(player.statusLabel)}</span>`);
            if (player.winRoundLabel) {
              _push(`<span class="result-round" data-v-696dfd93>${ssrInterpolate(player.winRoundLabel)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></li>`);
          ...
          _push(`<p class="overlay-empty" data-v-696dfd93>游戏结果将在服务端结算后显示。</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="overlay-auto-next-hint" data-v-696dfd93><span class="auto-next-spinner" data-v-696dfd93></span><span data-v-696dfd93>即将进入下一局...</span></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (drawBlockedNoticeVisible.value) {
        _push(`<div class="draw-blocked-notice" data-v-696dfd93>${ssrInterpolate(drawBlockedNoticeText.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (showSettlement.value) {
        _push(`<div class="settle-overlay" data-v-696dfd93><div class="settle-panel" data-v-696dfd93><h2 class="settle-title-center" data-v-696dfd93>${ssrInterpolate(isWallExhaustedSettlement.value ? "💨 流局了，下把翻倍！！" : "本局输赢")}</h2><div class="settle-rounds settle-rounds--single" data-v-696dfd93><div class="settle-round-card" data-v-696dfd93>`);
        if (currentSettlementRound.value) {
          _push(`<div class="settle-round-header" data-v-696dfd93><span data-v-696dfd93>第 ${ssrInterpolate(settlementRoundIndex.value)} 局</span><span data-v-696dfd93>全局倍数 ×${ssrInterpolate(currentSettlementRound.value.effectiveMultiplier)} / 结算倍数 ×${ssrInterpolate(currentSettlementRound.value.settlementMultiplier)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="settle-round-block" data-v-696dfd93><div class="settle-table-wrap" data-v-696dfd93><table class="settle-round-table settle-round-table--compact" data-v-696dfd93><thead data-v-696dfd93><tr data-v-696dfd93><th data-v-696dfd93>玩家</th><th data-v-696dfd93>胡序</th><th data-v-696dfd93>胡牌牌面</th><th data-v-696dfd93>花</th><th data-v-696dfd93>番数</th><th data-v-696dfd93>门清</th><th data-v-696dfd93>百搭</th><th data-v-696dfd93>自摸/捉冲</th><th data-v-696dfd93>总输赢</th></tr></thead><tbody data-v-696dfd93><!--[-->`);
        ssrRenderList(currentSettlementRows.value, (row) => {
          _push(`<tr class="${ssrRenderClass({ "settle-round-table-row--winner": row.isWinner })}" data-v-696dfd93><td data-v-696dfd93>${ssrInterpolate(row.playerName)}</td><td data-v-696dfd93>${ssrInterpolate(row.winSequence)}</td><td class="settle-round-tiles" data-v-696dfd93>${ssrInterpolate(row.tiles)}</td><td data-v-696dfd93>${ssrInterpolate(row.flowerCount)}</td><td data-v-696dfd93>${ssrInterpolate(row.baseFan)}</td><td data-v-696dfd93>${ssrInterpolate(row.menQing)}</td><td data-v-696dfd93>${ssrInterpolate(row.wild)}</td><td data-v-696dfd93>${ssrInterpolate(row.winMode)}</td><td class="${ssrRenderClass({ "settle-round-positive": row.score > 0, "settle-round-negative": row.score < 0 })}" data-v-696dfd93>${ssrInterpolate(row.scoreLabel)}</td></tr>`);
        });
        _push(`<!--]--></tbody></table></div></div></div></div>`);
        if (isSettleRequested.value && settlementData.value?.playerStats) {
          _push(`<div class="settle-details" style="${ssrRenderStyle({ "border-top": "1px solid rgba(255,215,0,0.15)", "padding-top": "16px", "margin-top": "10px" })}" data-v-696dfd93><h3 class="settle-title-center" style="${ssrRenderStyle({ "font-size": "1.1rem", "margin-bottom": "14px" })}" data-v-696dfd93>📊 总成绩单</h3><div class="settle-detail-header" data-v-696dfd93><span class="settle-detail-name" data-v-696dfd93></span><span class="settle-detail-stat settle-detail-stat--record" data-v-696dfd93>总输赢</span><span class="settle-detail-stat settle-detail-stat--record" data-v-696dfd93>有效输赢</span><span class="settle-detail-stat" data-v-696dfd93>🤖 vs AI</span><span class="settle-detail-stat" data-v-696dfd93>🀄 自摸</span><span class="settle-detail-stat" data-v-696dfd93>🎯 捉冲</span><span class="settle-detail-stat settle-detail-stat--win" data-v-696dfd93>最大赢</span><span class="settle-detail-stat settle-detail-stat--loss" data-v-696dfd93>最大输</span></div><div class="settle-detail-grid" data-v-696dfd93><!--[-->`);
          ssrRenderList(sortedSettleStats.value, (stat) => {
            _push(`<div class="settle-detail-row" data-v-696dfd93><span class="settle-detail-name" data-v-696dfd93>${ssrInterpolate(stat.name)}</span><span class="settle-detail-stat settle-detail-stat--record" data-v-696dfd93>${ssrInterpolate((stat.totalScore ?? 0) > 0 ? "+" : "")}${ssrInterpolate(stat.totalScore ?? 0)}</span><span class="settle-detail-stat settle-detail-stat--record" data-v-696dfd93>${ssrInterpolate(stat.effectiveScore ?? stat.totalScore ?? 0)}</span><span class="settle-detail-stat" data-v-696dfd93>${ssrInterpolate(stat.vsAiScore ?? 0)}</span><span class="settle-detail-stat" data-v-696dfd93>${ssrInterpolate(stat.selfDraws ?? 0)}</span><span class="settle-detail-stat" data-v-696dfd93>${ssrInterpolate(stat.discards ?? 0)}</span><span class="settle-detail-stat settle-detail-stat--win" data-v-696dfd93>+${ssrInterpolate(stat.maxWin ?? 0)}</span><span class="settle-detail-stat settle-detail-stat--loss" data-v-696dfd93>${ssrInterpolate(stat.maxLoss ?? 0)}</span></div>`);
          });
          _push(`<!--]--></div><p style="${ssrRenderStyle({ "text-align": "center", "font-size": "0.72rem", "opacity": "0.5", "margin-top": "10px" })}" data-v-696dfd93>有效输赢 = 仅统计纯真人局的输赢，排除与AI对战的部分</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="settle-actions" data-v-696dfd93>`);
        if (isWallExhaustedSettlement.value) {
          _push(`<div class="auto-next-countdown" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px", "margin-bottom": "8px", "justify-content": "center", "font-size": "0.85rem", "opacity": "0.8" })}" data-v-696dfd93><span class="auto-next-spinner" data-v-696dfd93></span><span data-v-696dfd93>倒计时 ${ssrInterpolate(wallExhaustedCountdown.value)}s 后自动下一局</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "8px", "justify-content": "center" })}" data-v-696dfd93>`);
        if (canReviewHuSelection.value) {
          _push(`<button class="settle-save-btn settle-save-btn--secondary" data-v-696dfd93> 回看胡牌选择 </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="settle-save-btn" data-v-696dfd93> 下一局${ssrInterpolate(isWallExhaustedSettlement.value && wallExhaustedCountdown.value > 0 ? " (" + wallExhaustedCountdown.value + "s)" : "")}</button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ssrRenderTeleport(_push, (_push2) => {
        if (showSettings.value) {
          _push2(`<div class="glass-settings-panel" style="${ssrRenderStyle(settingsPanelStyle.value)}" data-v-696dfd93><div class="glass-settings-arrow" data-v-696dfd93></div><div class="glass-settings-body" data-v-696dfd93><div class="glass-settings-section" data-v-696dfd93><div class="glass-settings-section-header" data-v-696dfd93><div class="glass-settings-section-title" data-v-696dfd93>对局操作</div><div class="glass-settings-section-subtitle" data-v-696dfd93>只保留正在生效的出牌与音效控制</div></div><div class="glass-settings-stack" data-v-696dfd93><div class="glass-settings-row glass-settings-row--panel" data-v-696dfd93><div class="glass-settings-row-main" data-v-696dfd93><span class="glass-settings-icon" data-v-696dfd93>${ssrInterpolate(unref(soundEnabled) ? "🔊" : "🔇")}</span><div class="glass-settings-copy" data-v-696dfd93><span class="glass-settings-label" data-v-696dfd93>总音效</span><span class="glass-settings-help" data-v-696dfd93>控制摸牌、碰杠胡、广播提示等音效播放</span></div></div><div class="${ssrRenderClass([{ "glass-toggle--on": unref(soundEnabled) }, "glass-toggle"])}" data-v-696dfd93><div class="glass-toggle-knob" data-v-696dfd93></div></div></div><div class="glass-settings-card" data-v-696dfd93><div class="glass-settings-card-title" data-v-696dfd93>出牌方式</div><div class="glass-settings-card-subtitle" data-v-696dfd93>移动端支持双击、点选确认、拖拽出牌</div><div class="glass-theme-options" data-v-696dfd93><button class="${ssrRenderClass([{ "glass-theme-chip--active": discardMode.value === "double_tap" }, "glass-theme-chip"])}" data-v-696dfd93>双击</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": discardMode.value === "tap_confirm" }, "glass-theme-chip"])}" data-v-696dfd93>点选确认</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": discardMode.value === "drag" }, "glass-theme-chip"])}" data-v-696dfd93>拖拽出牌</button></div></div></div></div><div class="glass-settings-section" data-v-696dfd93><div class="glass-settings-section-header" data-v-696dfd93><div class="glass-settings-section-title" data-v-696dfd93>语音与音乐</div><div class="glass-settings-section-subtitle" data-v-696dfd93>语音音量和背景音乐在同一区块内集中管理</div></div><div class="glass-settings-stack" data-v-696dfd93><div class="glass-settings-card" data-v-696dfd93><div class="glass-settings-card-title" data-v-696dfd93>出牌语音</div><div class="glass-settings-select-wrap glass-settings-select-wrap--compact" data-v-696dfd93><div class="glass-settings-select-label" data-v-696dfd93>语音音色</div><select class="glass-settings-select"${ssrRenderAttr("value", unref(currentScheme))} data-v-696dfd93><option value="bingtang" data-v-696dfd93>冰糖</option><option value="baihua" data-v-696dfd93>白桦</option></select></div><div class="glass-settings-select-wrap glass-settings-select-wrap--compact" data-v-696dfd93><div class="glass-settings-select-label" data-v-696dfd93>语音音量 ${ssrInterpolate(voiceVolumePercent.value)}%</div><input class="glass-settings-range" type="range" min="0" max="100" step="1"${ssrRenderAttr("value", voiceVolumePercent.value)} data-v-696dfd93></div></div><div class="glass-settings-card" data-v-696dfd93><div class="glass-settings-card-title" data-v-696dfd93>背景音乐</div><div class="glass-settings-row glass-settings-row--panel" data-v-696dfd93><div class="glass-settings-row-main" data-v-696dfd93><span class="glass-settings-icon" data-v-696dfd93>${ssrInterpolate(unref(bgmEnabled) ? "🎶" : "🔇")}</span><div class="glass-settings-copy" data-v-696dfd93><span class="glass-settings-label" data-v-696dfd93>背景音乐开关</span><span class="glass-settings-help" data-v-696dfd93>控制牌桌内循环播放的曲目</span></div></div><div class="${ssrRenderClass([{ "glass-toggle--on": unref(bgmEnabled) }, "glass-toggle"])}" data-v-696dfd93><div class="glass-toggle-knob" data-v-696dfd93></div></div></div><div class="glass-settings-select-wrap glass-settings-select-wrap--compact" data-v-696dfd93><div class="glass-settings-select-label" data-v-696dfd93>曲目</div><select class="glass-settings-select"${ssrRenderAttr("value", unref(bgmCurrentTrackId) || "")} data-v-696dfd93><option value="" disabled data-v-696dfd93>选择背景音乐</option><!--[-->`);
          ssrRenderList(unref(bgmTracks), (track) => {
            _push2(`<option${ssrRenderAttr("value", track.id)} data-v-696dfd93>${ssrInterpolate(track.label)}</option>`);
          });
          _push2(`<!--]--></select></div><div class="glass-settings-select-wrap glass-settings-select-wrap--compact" data-v-696dfd93><div class="glass-settings-select-label" data-v-696dfd93>循环方式</div><select class="glass-settings-select"${ssrRenderAttr("value", unref(bgmLoopMode))} data-v-696dfd93><option value="single" data-v-696dfd93>单曲循环</option><option value="all" data-v-696dfd93>列表循环</option><option value="shuffle" data-v-696dfd93>随机循环</option></select></div><div class="glass-settings-select-wrap glass-settings-select-wrap--compact" data-v-696dfd93><div class="glass-settings-select-label" data-v-696dfd93>音乐音量 ${ssrInterpolate(bgmVolumePercent.value)}%</div><input class="glass-settings-range" type="range" min="0" max="100" step="1"${ssrRenderAttr("value", bgmVolumePercent.value)} data-v-696dfd93></div><div class="glass-settings-music-actions" data-v-696dfd93><button class="glass-theme-chip" type="button" data-v-696dfd93>${ssrInterpolate(unref(bgmIsPlaying) ? "暂停" : "播放")}</button><button class="glass-theme-chip" type="button" data-v-696dfd93>下一首</button></div></div></div></div><div class="glass-settings-section" data-v-696dfd93><div class="glass-settings-section-header" data-v-696dfd93><div class="glass-settings-section-title" data-v-696dfd93>牌桌外观</div><div class="glass-settings-section-subtitle" data-v-696dfd93>桌布与牌背分开归类，层次更清楚</div></div><div class="glass-settings-stack" data-v-696dfd93><div class="glass-settings-card" data-v-696dfd93><div class="glass-settings-card-title" data-v-696dfd93>桌布方案</div><div class="glass-theme-options" data-v-696dfd93><button class="${ssrRenderClass([{ "glass-theme-chip--active": tableTheme.value === "classic-green" }, "glass-theme-chip"])}" data-v-696dfd93>经典绿</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": tableTheme.value === "jade-green" }, "glass-theme-chip"])}" data-v-696dfd93>翡翠青</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": tableTheme.value === "royal-red" }, "glass-theme-chip"])}" data-v-696dfd93>赤金红</button></div></div><div class="glass-settings-card" data-v-696dfd93><div class="glass-settings-card-title" data-v-696dfd93>牌背颜色</div><div class="glass-theme-options" data-v-696dfd93><button class="${ssrRenderClass([{ "glass-theme-chip--active": tileBackScheme.value === 0 }, "glass-theme-chip"])}" data-v-696dfd93>原版绿</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": tileBackScheme.value === 1 }, "glass-theme-chip"])}" data-v-696dfd93>象牙白</button><button class="${ssrRenderClass([{ "glass-theme-chip--active": tileBackScheme.value === 2 }, "glass-theme-chip"])}" data-v-696dfd93>卡布里蓝</button></div></div></div></div><div class="glass-settings-footer" data-v-696dfd93><span data-v-696dfd93>长青阁麻将 v2.2</span></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      _push(`<div class="table-wrapper" data-v-696dfd93><div class="mahjong-table" data-v-696dfd93><div class="${ssrRenderClass([`table-felt--${tableTheme.value}`, "table-felt"])}" data-v-696dfd93><div class="cross-marker" data-v-696dfd93><div class="cross-h" data-v-696dfd93></div><div class="cross-v" data-v-696dfd93></div></div><div class="center-glow" data-v-696dfd93></div>`);
      if (topPlayer.value) {
        _push(`<div class="player-name-label player-name-label--top" data-v-696dfd93>${ssrInterpolate(topPlayer.value.name)} `);
        if (northIsWinner.value) {
          _push(`<span class="winner-tag" data-v-696dfd93>胡</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (leftPlayer.value) {
        _push(`<div class="player-name-label player-name-label--left" data-v-696dfd93>${ssrInterpolate(leftPlayer.value.name)} `);
      ...
      if (rightPlayer.value) {
        _push(`<div class="player-name-label player-name-label--right" data-v-696dfd93>${ssrInterpolate(rightPlayer.value.name)} `);
      ...
      _push(`</div><div class="${ssrRenderClass([{ "seat-active": activePosition.value !== null && topPlayer.value?.position === activePosition.value }, "seat seat-top"])}" data-v-696dfd93>`);
      ...
      _push(`</div><div class="${ssrRenderClass([{ "seat-active": activePosition.value !== null && leftPlayer.value?.position === activePosition.value }, "seat seat-left"])}" data-v-696dfd93>`);
      _push(ssrRenderComponent(PlayerOtherArea, {
        position: "left",
        hand: westHand.value,
      ...
      _push(`</div><div class="${ssrRenderClass([{ "seat-active": activePosition.value !== null && rightPlayer.value?.position === activePosition.value }, "seat seat-right"])}" data-v-696dfd93>`);
      _push(ssrRenderComponent(PlayerOtherArea, {
        position: "right",
        hand: eastHand.value,
      ...
      _push(`</div><div class="seat seat-bottom" data-v-696dfd93><div class="self-area-with-actions" data-v-696dfd93>`);
      ...
      if (isSpectator.value) {
        _push(`<div class="spectating-hint" data-v-696dfd93><span class="spectating-hint-icon" data-v-696dfd93>📺</span><span class="spectating-hint-text" data-v-696dfd93>正在观看 <strong data-v-696dfd93>${ssrInterpolate(watchingPlayerName.value)}</strong> 的手牌</span><button class="mahjong-button small" data-v-696dfd93>退出观赛</button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isSpectator.value) {
        _push(`<div class="inline-action-buttons inline-action-buttons--spectator" data-v-696dfd93><div class="spectator-badge" data-v-696dfd93>📺 观赛中</div></div>`);
      } else if (canReviewLatestHuSelection.value && !isAIControlled.value) {
        _push(`<div class="inline-action-buttons inline-action-buttons--review" data-v-696dfd93><button class="inline-action-btn inline-action-btn--review" data-v-696dfd93>回看胡牌选项</button></div>`);
      } else if (isAIControlled.value) {
        _push(`<div class="inline-action-buttons" data-v-696dfd93><div class="ai-controlled-notice" data-v-696dfd93> 🤖 已由AI自动出牌 </div><button class="inline-action-btn inline-action-btn--comeback" data-v-696dfd93>我回来了</button></div>`);
      } else if (unref(isConnected) && !isInteractionLocked.value) {
        _push(`<div class="inline-action-buttons" style="${ssrRenderStyle({ "display": "none" })}" data-v-696dfd93>`);
        if (actionWindowText.value) {
          _push(`<div class="inline-action-timer" data-v-696dfd93>${ssrInterpolate(actionWindowText.value)}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (showChow.value) {
          _push(`<button class="inline-action-btn inline-action-btn--chow inline-action-btn--claim-pulse"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93>吃</button>`);
        } else {
          _push(`<!---->`);
        }
        if (showPeng.value) {
          _push(`<button class="inline-action-btn inline-action-btn--peng inline-action-btn--claim-pulse"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93>碰</button>`);
        } else {
          _push(`<!---->`);
        }
        if (showKong.value || showConcealedKong.value || showExtendedKong.value) {
          _push(`<button class="inline-action-btn inline-action-btn--kong inline-action-btn--claim-pulse"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93>杠</button>`);
        } else {
          _push(`<!---->`);
        }
        if (showRebel.value) {
          _push(`<button class="${ssrRenderClass([{ "inline-action-btn--frozen": thinkFreezeActive.value }, "inline-action-btn inline-action-btn--rebel"])}"${ssrIncludeBooleanAttr(isInteractionLocked.value || thinkFreezeActive.value) ? " disabled" : ""} data-v-696dfd93>🚨造反</button>`);
        } else {
          _push(`<!---->`);
        }
        if (showLiangShanButton.value) {
          _push(`<button class="${ssrRenderClass([{ "inline-action-btn--liangshan-voted": hasVotedLiangShan.value, "inline-action-btn--frozen": thinkFreezeActive.value }, "inline-action-btn inline-action-btn--liangshan"])}"${ssrIncludeBooleanAttr(!canLiangShan.value || isInteractionLocked.value || hasVotedLiangShan.value || thinkFreezeActive.value) ? " disabled" : ""} data-v-696dfd93>🔥${ssrInterpolate(hasVotedLiangShan.value ? "已聚义" : "梁山聚义")}</button>`);
        } else {
          _push(`<!---->`);
        }
        if (!showDraw.value && !showChow.value && !showPeng.value && !showKong.value && !showHu.value && !showConcealedKong.value && !showExtendedKong.value && !showRebel.value && !showLiangShanButton.value) {
          _push(`<div class="inline-action-waiting" data-v-696dfd93> 等待中… </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      } else if (!unref(isConnected)) {
        _push(`<div class="inline-action-buttons" data-v-696dfd93><div class="inline-action-waiting" data-v-696dfd93>连接中...</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></div><aside class="extended-info-panel" data-v-696dfd93>`);
      if (unref(gameState)) {
        _push(`<div class="room-header-row panel-room-header-row" data-v-696dfd93><button class="${ssrRenderClass([{ "room-header-toggle--collapsed": isTopBarCollapsed.value }, "room-header-toggle room-header-toggle--inline"])}"${ssrRenderAttr("aria-expanded", String(!isTopBarCollapsed.value))}${ssrRenderAttr("title", isTopBarCollapsed.value ? "展开菜单" : "收起菜单")} data-v-696dfd93><span class="room-header-toggle__icon" data-v-696dfd93>${ssrInterpolate(isTopBarCollapsed.value ? "▼" : "▲")}</span></button><p class="mahjong-subtitle panel-room-number" data-v-696dfd93> 房间 #${ssrInterpolate(unref(gameState)?.roomNumber || "????")}</p>`);
      ...
      if (isMobileLandscapeMode.value && !isTopBarCollapsed.value) {
        _push(`<div class="ext-section mobile-inline-menu" data-v-696dfd93><div class="mobile-inline-menu__actions" data-v-696dfd93><button class="mahjong-button small secondary" data-v-696dfd93> ⚙️ 设置 </button><button class="mahjong-button small secondary" data-v-696dfd93> 📖 规则 </button><button class="mahjong-button small" data-v-696dfd93> 返回大厅 </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (isAdminUser.value) {
        _push(`<div class="ext-section" data-v-696dfd93><h3 class="ext-title" data-v-696dfd93>调试</h3><p class="ext-meta" data-v-696dfd93>阶段: ${ssrInterpolate(unref(gameState)?.phase)} · ${ssrInterpolate(unref(gameState)?.players.length)}人</p>`);
        if (unref(gameState)?.phase === "waiting" && (unref(gameState)?.players.length || 0) < 4) {
          _push(`<div style="${ssrRenderStyle({ "margin-bottom": "6px" })}" data-v-696dfd93><button class="mahjong-button panel-button small"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93> 添加机器人 → 掷骰子 </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="mahjong-button panel-button small"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93>刷新</button><button class="mahjong-button panel-button small"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93>${ssrInterpolate(shouldRevealOpponents.value ? "隐藏手牌" : "显示手牌")}</button>`);
        if (unref(gameState)?.phase === "playing") {
          _push(`<div style="${ssrRenderStyle({ "margin-top": "8px" })}" data-v-696dfd93><!--[-->`);
          ssrRenderList(otherPlayers.value, (p) => {
            _push(`<p class="ext-meta" data-v-696dfd93>${ssrInterpolate(p.name)} <button class="mahjong-button panel-button small" style="${ssrRenderStyle({ "display": "inline", "padding": "2px 8px", "font-size": "0.7rem", "margin-left": "4px" })}"${ssrIncludeBooleanAttr(isInteractionLocked.value || unref(gameState)?.currentPlayerIndex !== p.position) ? " disabled" : ""} data-v-696dfd93> 出牌 </button></p>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
      ...
      if (isAdminUser.value && canCheatHu.value) {
        _push(`<div class="ext-section" data-v-696dfd93><button class="mahjong-button panel-button"${ssrIncludeBooleanAttr(isInteractionLocked.value) ? " disabled" : ""} data-v-696dfd93> 测试胡牌 </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!isPreGameTransition.value && !isSpectator.value) {
        _push(`<div class="action-buttons-panel" data-v-696dfd93><div class="ting-preview-section" data-v-696dfd93><div class="ting-preview-label" role="button" tabindex="0" data-v-696dfd93><span class="ting-preview-label__text" data-v-696dfd93>听牌</span><span class="ting-preview-label__toggle" data-v-696dfd93>${ssrInterpolate(tingPreviewEnabled.value ? "✕" : "☰")}</span>`);
        if (tingPreviewEnabled.value) {
          _push(`<!--[--><span class="ting-preview-label__colon" data-v-696dfd93>：</span>`);
          if (tingPreviewItems.value.length) {
            _push(`<!--[-->`);
            ssrRenderList(tingPreviewItems.value, (item) => {
              _push(`<span class="${ssrRenderClass([{ "ting-preview-tile--exhausted": item.isExhausted }, "ting-preview-tile"])}" data-v-696dfd93>${ssrInterpolate(item.label)}</span>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<span class="ting-preview-label__hint" data-v-696dfd93>未听牌</span>`);
          }
          _push(`<!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (thinkFreezeActive.value || isAIControlled.value || showMobileActionNotice.value) {
          _push(`<div class="turn-status-text" data-v-696dfd93>`);
        ...
        _push(`<div class="extra-actions-bar" data-v-696dfd93><span class="extra-actions-label" data-v-696dfd93>更多操作</span><button class="extra-action-btn extra-action-btn--liangshan"${ssrIncludeBooleanAttr(canLiangShan.value === false || isInteractionLocked.value || !unref(isConnected) || hasVotedLiangShan.value || thinkFreezeActive.value) ? " disabled" : ""} data-v-696dfd93>🔥 ${ssrInterpolate(hasVotedLiangShan.value ? "已聚义" : "聚义")}</button><button class="extra-action-btn extra-action-btn--rebel"${ssrIncludeBooleanAttr(showRebel.value === false || isInteractionLocked.value || !unref(isConnected) || thinkFreezeActive.value) ? " disabled" : ""} data-v-696dfd93>🚨 造反</button>`);
        if (showHu.value) {
          _push(`<button class="extra-action-btn extra-action-btn--hu"${ssrIncludeBooleanAttr(isInteractionLocked.value || isAIControlled.value) ? " disabled" : ""} data-v-696dfd93>🏆 您胡了</button>`);
        } else {
          _push(`<!---->`);
        }
        if (isWinner.value) {
          _push(`<span class="turn-timer-inline turn-timer--winner" data-v-696dfd93>🎉 你赢了！</span>`);
        } else {
          _push(`<!---->`);
        }
        if (turnTimerActive.value && !isWinner.value && !isAIControlled.value) {
          _push(`<span class="${ssrRenderClass([{ "turn-timer--urgent": turnTimer.value <= 10 }, "turn-timer-inline"])}" data-v-696dfd93> ⏱ ${ssrInterpolate(turnTimer.value)}s </span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (showDoubleReminder.value) {
          _push2(`<div class="double-reminder-overlay" data-v-696dfd93><div class="double-reminder-msg" data-v-696dfd93>${ssrInterpolate(_ctx.doubleReminderText)}</div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      ssrRenderTeleport(_push, (_push2) => {
        if (flowerReplacementNotice.value) {
          _push2(`<div class="flower-replace-overlay" data-v-696dfd93><div class="flower-replace-chip" data-v-696dfd93><span class="flower-replace-text" data-v-696dfd93>补花补上</span>`);
        ...
        if (showPlayerCard.value) {
          _push2(`<div class="ai-card-overlay" data-v-696dfd93><div class="ai-card" data-v-696dfd93><div class="ai-card-header" data-v-696dfd93><span class="ai-card-avatar" data-v-696dfd93>${ssrInterpolate(isBotPlayer(playerCardPlayer.value) ? "🤖" : "🀄")}</span><span class="ai-card-name" data-v-696dfd93>${ssrInterpolate(playerCardPlayer.value?.name)}</span></div><div class="ai-card-body" data-v-696dfd93>`);
          if (playerCardPlayer.value?.id === unref(currentPlayer)?.id) {
            _push2(`<!--[--><button class="ai-card-btn ai-card-btn--leave" data-v-696dfd93> 🪑 暂时离席 <span class="ai-card-hint" data-v-696dfd93>下把起身，位置空出</span></button><button class="ai-card-btn ai-card-btn--replace" data-v-696dfd93> 🤖 托管 <span class="ai-card-hint" data-v-696dfd93>AI接管，继续游戏</span></button><!--]-->`);
          } else if (isBotPlayer(playerCardPlayer.value)) {
            _push2(`<!--[-->`);
            if (!isSpectator.value) {
              _push2(`<button class="ai-card-btn ai-card-btn--spectate"${ssrIncludeBooleanAttr(!canUseSpectatorView.value) ? " disabled" : ""} data-v-696dfd93> 👁️ ${ssrInterpolate(spectatingId.value === playerCardPlayer.value?.id ? "取消观赛" : "观赛TA")} <span class="ai-card-hint" data-v-696dfd93>${ssrInterpolate(canUseSpectatorView.value ? "查看对方手牌" : "当前条件下不可观赛")}</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (isSpectator.value) {
              _push2(`<button class="ai-card-btn ai-card-btn--replace"${ssrIncludeBooleanAttr(isReplacingBot.value) ? " disabled" : ""} data-v-696dfd93> 🙋 下局替换TA <span class="ai-card-hint" data-v-696dfd93>此AI下局退出，你上位</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button class="ai-card-btn ai-card-btn--leave" data-v-696dfd93> 🚪 出局 <span class="ai-card-hint" data-v-696dfd93>下局移除该AI</span></button>`);
            if (isSpectatorGamePlayer.value) {
              _push2(`<button class="ai-card-btn ai-card-btn--replace" data-v-696dfd93> 🙋 换我上 <span class="ai-card-hint" data-v-696dfd93>下局由你接替</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--]-->`);
            ...
            if (canSwap.value) {
              _push2(`<button class="ai-card-btn ai-card-btn--swap" data-v-696dfd93> 🔄 跟TA换位置 <span class="ai-card-hint" data-v-696dfd93>剩余 ${ssrInterpolate(mySwapInfo.value.remaining)} 次机会</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--]-->`);
          ...
          _push2(`</div><button class="ai-card-close" data-v-696dfd93>✕</button></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      ...
      if (showDebugPanel.value) {
        _push(`<div style="${ssrRenderStyle({ "position": "fixed", "top": "4px", "left": "4px", "z-index": "99999", "background": "rgba(0,0,0,0.85)", "color": "#0f0", "font-size": "10px", "font-family": "monospace", "padding": "3px 6px", "border-radius": "4px", "pointer-events": "none", "white-space": "pre" })}" data-v-696dfd93>${ssrInterpolate(debugViewport.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
const _roomId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-696dfd93"]]);

export { _roomId_ as default };
//# sourceMappingURL=_roomId_-Bi_T3vgK.mjs.map
