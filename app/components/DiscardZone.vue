...
.discard-zone {
  ...
  --discard-gap-x: var(--discard-gap-x-override, clamp(0px, calc(var(--discard-tile-w) * 0.001), 0.05px));
  --discard-gap-y: var(--discard-gap-y-override, clamp(0px, calc(var(--discard-tile-h) * 0.001), 0.05px));
