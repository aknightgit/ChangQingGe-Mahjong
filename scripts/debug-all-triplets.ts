...
// 测试1: 123 456 789 11万 (明显有顺子)
const hand1 = [...Ts('wan', [1,2,3,4,5,6,7,8,9,1,1])];
const result1 = canWin(hand1, [], null);
console.log('测试1 (123 456 789 11万):');
...
// 测试3: 123 234 345 456 77万 (纯顺子)
const hand3 = [...Ts('wan', [1,2,3,2,3,4,3,4,5,4,5,6,7,7])];
const result3 = canWin(hand3, [], null);
console.log('\n测试3 (123 234 345 456 77万):');
...
const hand4 = nonFlowers.slice(0, 14);
...
// 测试5: 模拟真实游戏场景 - 有exposed melds
const hand5 = [...Ts('wan', [1,2,3,4,5])];
const exposed5: Meld[] = [
  { type: MeldType.TRIPLET, tiles: Ts('wan', [6,6,6]), isConcealed: false },
  { type: MeldType.TRIPLET, tiles: Ts('wan', [7,7,7]), isConcealed: false },
];
const result5 = canWin(hand5, exposed5, null);
console.log('\n测试5 (手牌12345万 + 门口666 777):');
