---
创建时间: 2026-04-08T11:52:32.719Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 1 games = 1 total
---

## Round 1 (2026-04-08 11:52:32)
...
**局次0**（自摸 · ×1）
  - AI-AK: 普通 ·  · 碰:二条 二条 二条; 碰:一万 一万 一万; 顺:二万 三万 四万 五万 六万 七万 → 400点
  - AI-小胖: 普通 ·  · 碰:四筒 四筒 四筒; 杠:二筒 二筒 二筒 二筒 → 180点
  - AI-老赵: 普通 ·  · 碰:南 南 南; 碰:七条 七条 七条 → 40点
...
```json
{
  ...
  "windWestKeep": 1.2614505721384577,
  ...
  "wild3RouteAllPungsBoost": 0.45733000989174766,
  ...
  "wild1MenqingKeep": 1.4976228530864515,
  "wild2MenqingKeep": 1,
  ...
  "flushVsPungsBalance": -0.051813797967646985,
...
**胡牌玩家明细：**
  - 玩家: AI-老赵
    - 胡牌方式: 自摸
    - 牌型/基础番/最终点: — / 40 / 400
    - 手牌牌面: 二条 三条 一条 四条 三条 西 西 一条 南 南 南 七条 七条 七条
    - 门口牌（吃/碰/杠）: 碰:南 南 南 ; 碰:七条 七条 七条
    - 花牌: 竹
**三口/四口关系：**
...
**结算逐笔明细：**
  ...
  - [放炮] AI-AK -> AI-小胖 : 180 (18×10×1)
  - [放炮] AI-小胖 -> AI-老赵 : 40 (4×10×1)
