...
### 第1轮 (强度=1.0, 停滞=0)
  C1: fitness=-88454 hu=0% self=0% disc=0% draws=50
  C2: fitness=-86616 hu=2% self=0% disc=100% draws=49
  C3: fitness=-88454 hu=0% self=0% disc=0% draws=50
  C4: fitness=-86616 hu=2% self=0% disc=100% draws=49
  C5: fitness=-86616 hu=2% self=100% disc=0% draws=49
  Best: -86616 (overall: -86616) [plateau: 1]
  指标: hu=2% self=0% disc=100% big=0% mq=100%

## Round 1 (2026-04-09T03:29:22.478Z)
...
```json
{
  ...
  "meldPenalty": 0.0156913544470138,
  ...
  "wild3BaoPush": 0.8,
  "multLowSpeedBias": 0.5411791003782753,
