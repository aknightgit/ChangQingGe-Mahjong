...
- 创建时间: 2026-04-06T23:57:13.404Z
- 训练脚本: train-ai-ak.ts
- Config: 1 rounds × 1000 games = 1000 total
...
## 基线成绩（第0轮）
AI-AK baseline: score=0  wins=0/1000  draws=999
### 第1轮 (强度=1.0, 停滞=0)
  Candidate 1: score=0  wins=0/1000 (0.0%)  draws=1000
  Candidate 2: score=0  wins=0/1000 (0.0%)  draws=999
  Candidate 3: score=0  wins=0/1000 (0.0%)  draws=1000
  Candidate 4: score=0  wins=0/1000 (0.0%)  draws=1000
  Best this round: 0  (overall best: 0)  [plateau: 1]
  Current standings: AI-AK:0(0%)  AI-小胖:0(0%)  AI-阿水:0(0%)  AI-老赵:0(0%)

## Round 1 (2026-04-06T23:58:00.423Z)
...
{
  "id": "AI-AK",
  "selfWinChance": 0.7699205863703759,
  "discardHuChance": 0.7,
  ...
  "chowChance": 0.34257164858167033,
  ...
  "wild2RouteAllPungsBoost": 0.3571803837498908,
  ...
  "sequenceVsTripletBias": 0.1453742184818631,
...
[性能] isTing缓存: 命中20576 未命中476581 命中率4.1%
[性能] canWin缓存: 命中34 未命中1269 命中率2.6%
