---
创建时间: 2026-04-08T04:05:48.937Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 5 games = 5 total
---

## Round 1 (2026-04-08 04:05:48)
...
**局次0**（放冲 · ×1）
  - AI-AK: 普通 · 七条 二万 六万 二万 六万 七条 五条 五条 · 碰:中 中 中; 碰:三条 三条 三条 → 70点
**局次1**（放冲 · ×1）
  - AI-老赵: 普通 · 七条 六条 四条 二筒 六条 四条 二筒 七条 · 碰:九万 九万 九万; 杠:七筒 七筒 七筒 七筒 → 50点
**局次2**（放冲 · ×1）
  - AI-小胖: 普通 · 西 二筒 四筒 一筒 二筒 四筒 西 一筒 · 碰:东 东 东; 碰:白 白 白 → 100点
**局次3**（放冲 · ×1）
  - AI-AK: 普通 · 三万 四万 白 一万 二万 二万 一万 一万 · 碰:中 中 中; 碰:七万 七万 七万 → 60点
**局次4**（自摸 · ×1）
  - AI-AK: 普通 · 九万 五筒 四筒 九万 五筒 · 碰:一万 一万 一万; 碰:六筒 六筒 六筒; 碰:八筒 八筒 八筒 → 30点
...
```json
{
  ...
  "discardHuChance": 0.7422527023341685,
  ...
  "terminalPenalty": 0.9558612553859838,
  ...
  "defenseRiskAversion": 0.3895887621748721,
  "wallTilesImpact": 0.2,
...
**胡牌玩家明细：**
  - 玩家: AI-AK
    ...
    - 牌型/基础番/最终点: 普通 / 3 / 30
    - 手牌牌面: 九万 五筒 四筒 九万 五筒
    - 门口牌（吃/碰/杠）: 碰:一万 一万 一万 ; 碰:六筒 六筒 六筒 ; 碰:八筒 八筒 八筒
    - 花牌: 夏
**结算逐笔明细：**
  - [自摸] AI-小胖 -> AI-AK : 30 (3×10×1)
  - [自摸] AI-阿水 -> AI-AK : 30 (3×10×1)
  - [自摸] AI-老赵 -> AI-AK : 30 (3×10×1)
