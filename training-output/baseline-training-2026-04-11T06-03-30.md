...
- 创建时间: 2026-04-11T06:03:50.801Z
- 训练脚本: train-baseline.ts
- Config: 1 rounds × 1 games = 1 total
- 模式: 4人共用同一策略，血战到最后一人
- 目标: 胡牌率≥90% 流局率<10% 血战率>80%
## 基线成绩（第0轮）
胡牌率=100.0%  流局率=0.0%  Fitness=25615.00
---
创建时间: 2026-04-11T06:03:50.796Z
训练脚本: train-baseline.ts
Config: 1 rounds × 1 games = 1 total
---

## Round 1 (2026-04-11 06:03:50)
...
**局次0**（放冲 · ×1）
  - undefined: 普通 ·  · (无副露) 
  - AI-小胖: 四百搭 · 四筒 五筒 六筒 八筒 九筒* 二筒 九筒* 四条 四条 七万 九筒* 九万 三条 九筒* · (无副露) → 20点
  - undefined: 普通 ·  · (无副露) 
