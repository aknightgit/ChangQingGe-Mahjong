...
- 创建时间: 2026-04-02T04:11:28.026Z
- 训练脚本: train-baseline.ts
- Config: 3 rounds × 100 games = 300 total
- 模式: 4人共用同一策略，血战到最后一人
- 目标指标:
  - 胡牌率 ≥90% (流局 <10%)
  - 血战率 >80%
...
### 第1轮 (强度=1.0, 停滞=0)
  C1: fitness=-2203 hu=2% self=50% disc=50% draws=98
  C2: fitness=-2203 hu=2% self=50% disc=50% draws=98
  C3: fitness=-2103 hu=7% self=57% disc=43% draws=93
  C4: fitness=-2245 hu=6% self=14% disc=86% draws=94
  C5: fitness=-2483 hu=4% self=0% disc=100% draws=96
  ★ NEW BEST! fitness=-2103
  指标: hu=7% self=57% disc=43% big=0% mq=0%

## Round 1 (2026-04-02T04:11:59.382Z)
...
### 第2轮 (强度=1.0, 停滞=0)
  C1: fitness=-2203 hu=2% self=50% disc=50% draws=98
  C2: fitness=-2141 hu=7% self=57% disc=43% draws=93
  C3: fitness=-2236 hu=3% self=67% disc=33% draws=97
  C4: fitness=-2143 hu=5% self=40% disc=60% draws=95
  C5: fitness=-2327 hu=2% self=50% disc=50% draws=98
  Best: -2141 (overall: -2103) [plateau: 1]
  指标: hu=7% self=57% disc=43% big=0% mq=29%

## Round 2 (2026-04-02T04:12:24.980Z)
...
```json
{
  ...
  "discardHuWildPenalty": 0.35,
  "discardHuMenQingPenalty": 0.12,
  "pengChance": 0.959769632702701,
  "kongChance": 0.47663989546774954,
  "chowChance": 0.15627782708545107,
  "anKongChance": 0.9898296447948148,
  "pengWildBoost": 0.06282849518815241,
  "kongWildBoost": 0.1769151208934808,
  ...
  "allHonorsPungsPursuit": 0.08389067735611558,
  "qingPengPursuit": 0.2,
  "hunPengPursuit": 0.4649299415252428,
  "windEastKeep": 2,
  "windSouthKeep": 2.4258378922864416,
  "windWestKeep": 1,
  "windNorthKeep": 0.7255064576387434,
  ...
  "wild3RouteMeldPush": 0.8,
  "wild1RouteFlushBoost": 0.33459464431743774,
  "wild2RouteFlushBoost": 0.3034955950181893,
  "wild3RouteFlushBoost": 0.47751980846352926,
  "wild1RouteHonorsBoost": 0,
  "wild2RouteHonorsBoost": 0.2,
  "wild3RouteHonorsBoost": 0.4,
  ...
  "wildMultHighAggression": 0.8,
  "wild0MenqingKeep": 3,
  "wild1MenqingKeep": 1.9940050386862482,
  "wild2MenqingKeep": 1,
  "wild1BaoPush": 0,
  "wild2BaoPush": 0.4801519550795235,
  "wild3BaoPush": 0.8,
...
### 第3轮 (强度=1.0, 停滞=1)
  C1: fitness=-2158 hu=7% self=43% disc=57% draws=93
  C2: fitness=-2307 hu=4% self=25% disc=75% draws=96
  C3: fitness=-2563 hu=0% self=0% disc=0% draws=100
  C4: fitness=-2421 hu=6% self=83% disc=17% draws=94
  C5: fitness=-2503 hu=3% self=0% disc=100% draws=97
  Best: -2158 (overall: -2103) [plateau: 2]
  指标: hu=7% self=43% disc=57% big=14% mq=29%

## Round 3 (2026-04-02T04:12:51.508Z)
...
{
  "id": "AI-AK",
  "selfWinChance": 0.794388134493717,
  "discardHuChance": 0.7,
  "selfWinWildBoost": 0.1,
  "discardHuWildPenalty": 0.35,
  "discardHuMenQingPenalty": 0.12,
  ...
  "bao2ClaimPenalty": 0.5522921350775664,
  "bao3AvoidThreshold": 0.7403525491739775,
  "baoSelfClaimCaution": 0.268417496867424,
  "wallEarlySpeedPush": 0.2830782739546156,
  "wallMidBalance": 0.4405118254914803,
  "wallLateDefense": 0.8293461896013391,
  "oppTingDetection": 0.5,
  ...
  "multHighHand7PureFlush": 0.7,
  "multHighHonorStart": 0.6353334176611241,
  "speedVsValueBalance": 0.4642787910755595,
  "defenseRiskAversion": 0.42466527676568333,
  "wallTilesImpact": 0.2,
  "baoRiskAversion": 0.4666330346059575,
  "baoThreshold": 2.001366078229792,
  ...
  "menqingDoubleAwareness": 0.5325238795068113,
  "flushVsPungsBalance": 0.1,
  "honorVsSuitedBalance": -0.10116954122622487,
  "sequenceVsTripletBias": -0.2,
  "wildOffenseStrategy": 0.5,
  "wildBailoutMeldBoost": 0.0635363073051163,
  "wildDefenseKeep": 0.3,
