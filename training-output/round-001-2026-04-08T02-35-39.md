---
创建时间: 2026-04-08T02:35:39.176Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 5 games = 5 total
---

## Round 1 (2026-04-08 02:35:39)
...
**每局获胜人数分布**（本轮所有胡牌局）
- 单人胡牌: 5局 | 双人胡牌: 0局 | 三人胡牌: 0局 | 四人胡牌: 0局
...
**局次0**（自摸 · ×1）
  - AI-AK: 普通 · 三万 三万 四万 三筒 三筒 · 碰:八万 八万 八万; 杠:二万 二万 二万 二万; 碰:五筒 五筒 五筒 → 50点
**局次1**（放冲 · ×1）
  - AI-阿水: 普通 · 九条 三条 四条 八条 八条 四条 九条 · 碰:六条 六条 六条; 碰:一万 一万 一万 
**局次2**（放冲 · ×1）
  - AI-AK: 普通 · 八筒 · 杠:四条 四条 四条 四条; 吃:二万 三万 四万; 吃:二万 三万 四万; 碰:一万 一万 一万 
**局次3**（放冲 · ×2）
  - AI-AK: 普通 · 七筒 · 碰:五条 五条 五条; 杠:六条 六条 六条 六条; 碰:八条 八条 八条; 碰:四条 四条 四条 
**局次4**（放冲 · ×1）
  - AI-阿水: 普通 · 七万 六万 七万 九万 九万 七万 六万 · 碰:一万 一万 一万; 碰:南 南 南 
...
```json
{
  ...
  "pengChance": 1,
  "kongChance": 0.5038842398805286,
  "chowChance": 0.35,
  "anKongChance": 0.9990993408170992,
  ...
  "qingPengPursuit": 0.5223488243273062,
  "hunPengPursuit": 0.5442411827354836,
  "windEastKeep": 1.7663111765725783,
  "windSouthKeep": 2.575719909145446,
  "windWestKeep": 1.0915211258809856,
  "windNorthKeep": 0.7667131831509256,
  "windGeneralKeep": 1.5,
  ...
  "wild3RouteMeldPush": 0.7988811807441566,
  ...
  "wild3BaoPush": 0.7635788527049263,
  ...
  "scoreBehindRiskBoost": 0.8971859717266517,
  "scoreLeadDefenseBoost": 1,
  "hand5RouteBias": 0.3123080868982012,
  "hand6RouteBias": 0.6,
  "hand7RouteBias": 0.8799619328279593,
  ...
  "multLowHand6HalfFlush": 0.2718410295822927,
  ...
  "multLowHand7HalfFlush": 0.4123748652396443,
  "multLowHand7PureFlush": 0.288198230096101,
  ...
  "kakanAggression": 0.4183877096757627,
...
**胡牌玩家明细：**
  - 玩家: AI-AK
    ...
    - 牌型/基础番/最终点: 普通 / 5 / 50
    - 手牌牌面: 三万 三万 四万 三筒 三筒
    - 门口牌（吃/碰/杠）: 碰:八万 八万 八万 ; 杠:二万 二万 二万 二万 ; 碰:五筒 五筒 五筒
    - 花牌: 梅 兰
**结算逐笔明细：**
  - [自摸] AI-小胖 -> AI-AK : 50 (5×10×1)
  - [自摸] AI-阿水 -> AI-AK : 50 (5×10×1)
  - [自摸] AI-老赵 -> AI-AK : 50 (5×10×1)
