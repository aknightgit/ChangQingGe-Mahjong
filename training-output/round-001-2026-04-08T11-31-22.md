---
创建时间: 2026-04-08T11:31:22.031Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 20 games = 20 total
---

## Round 1 (2026-04-08 11:31:22)
...
**局次16**（放冲 · ×2）
  - AI-AK: 普通 · 八筒 八筒 九筒 一筒 八筒 一筒 九筒 一筒 · 杠:五筒 五筒 五筒 五筒; 碰:发 发 发 → 200点
  - AI-老赵: 普通 · 白 八条 八条 白 七条 三条 八条 三条 · 碰:六筒 六筒 六筒; 碰:六万 六万 六万; 百搭:2张（tiao-3） → 40点
  - AI-小胖: 普通 · 一万 一万 二万 三条 二万 · 碰:二条 二条 二条 六条 六条 六条; 碰:九万 九万 九万; 百搭:1张（tiao-3） → 20点
...
{
  "id": "AI-AK",
  "selfWinChance": 0.8183625945467999,
  "discardHuChance": 0.7,
  ...
  "baoSelfClaimCaution": 0.42036811694145243,
  ...
  "hand6RouteBias": 0.6,
  "hand7RouteBias": 0.9,
  "multLowHand5AllPungs": 0.5297993198278061,
  ...
  "multHighHand6HalfFlush": 0.5342579217709578,
  ...
  "menqingDoubleAwareness": 0.43369404189167493,
...
**胡牌玩家明细：**
  - 玩家: AI-小胖
    ...
    - 牌型/基础番/最终点: — / 20 / 200
    - 手牌牌面: 一万 一万 二万 三条 二万
    - 门口牌（吃/碰/杠）: 碰:九万 九万 九万 ; 碰:二条 二条 二条 ; 碰:六条 六条 六条
    - 花牌: (无)
**结算逐笔明细：**
  - [放炮] AI-老赵 -> AI-AK : 400 (20×10×2)
  - [自摸] AI-AK -> AI-老赵 : 80 (4×10×2)
  - [自摸] AI-小胖 -> AI-老赵 : 80 (4×10×2)
  - [自摸] AI-阿水 -> AI-老赵 : 80 (4×10×2)
  - [放炮] AI-AK -> AI-小胖 : 40 (2×10×2)
