...
## Round 1 (2026-04-06T14:30:49.212Z)
...
```json
{
  ...
  "multHighHand5HalfFlush": 0.26424157225029227,
...
[性能] isTing缓存: 命中198 未命中4584 命中率4.1%
[性能] canWin缓存: 命中19 未命中888 命中率2.1%
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-小胖
    - 胡牌方式: 自摸
    - 手牌牌面: 九条 五万 八条 四条 一筒 八条 一筒 五万 四条 九条 一筒 五万 九条 四条
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 夏 冬 竹
