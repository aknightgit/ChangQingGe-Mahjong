...
## Round 1 (2026-04-06T12:17:16.940Z)
...
```json
{
  ...
  "windGeneralKeep": 1.5,
  "dragonRedKeep": 3.3540513598579347,
  ...
  "wild3RouteMeldPush": 0.8760209027312753,
  ...
  "wild2MenqingKeep": 1.118896170606698,
  "wild1BaoPush": 0.04609422068537318,
  ...
  "wallLateDefense": 0.7965354071705595,
  ...
  "multHighHand6PureFlush": 0.4390078499922749,
...
[性能] isTing缓存: 命中306 未命中11215 命中率2.7%
[性能] canWin缓存: 命中11 未命中877 命中率1.2%
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-老赵
    - 胡牌方式: 胡牌
    - 手牌牌面: 三条 发 六条 北 五条 发 北 六条 八条 四条 六条 发 八条
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 秋

- 三口/四口关系
  - AI-阿水 <-> AI-老赵: 三口 (A->B:3, B->A:0)

- 结算逐笔明细（谁付给谁、倍率和金额）
  - [放炮] AI-AK -> AI-老赵 : 0 (0x8)