...
### 第1轮 (强度=1.0, 停滞=0)
  C1: fitness=-88454 hu=0% self=0% disc=0% draws=1
  C2: fitness=-88454 hu=0% self=0% disc=0% draws=1
  C3: fitness=-88454 hu=0% self=0% disc=0% draws=1
  C4: fitness=-88454 hu=0% self=0% disc=0% draws=1
  C5: fitness=-88454 hu=0% self=0% disc=0% draws=1
  Best: -88454 (overall: -88454) [plateau: 1]
  指标: hu=0% self=0% disc=0% big=0% mq=0%

## Round 1 (2026-04-09T10:55:00.194Z)
...
```json
{
  ...
  "discardHuChance": 0.7,
  "selfWinWildBoost": 0.13745657681165663,
  ...
  "meldPenalty": 0.035780391316675014,
  ...
  "windSouthKeep": 2.254224441697217,
  "windWestKeep": 1.1156865715889224,
  "windNorthKeep": 0.7255064576387434,
  "windGeneralKeep": 1.5,
  "dragonRedKeep": 3.4761834027190197,
  ...
  "wild3RouteFlushBoost": 0.474823889097963,
  ...
  "wildMultHighAggression": 0.7383913413815654,
