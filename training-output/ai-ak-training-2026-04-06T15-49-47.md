...
## Round 1 (2026-04-06T15:49:47.879Z)
...
```json
{
  ...
  "discardHuChance": 0.7,
  "selfWinWildBoost": 0.14535938259482475,
  ...
  "allHonorsPursuit": 0.06828763192967503,
  ...
  "wild1RouteFlushBoost": 0.3033646120237232,
  ...
  "wildMultLowAggression": 0.5651938069956842,
  ...
  "multLowHand6AllPungs": 0.27007628443163506,
...
[性能] isTing缓存: 命中105 未命中2390 命中率4.2%
[性能] canWin缓存: 命中21 未命中980 命中率2.1%
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-老赵
    - 胡牌方式: 自摸
    - 手牌牌面: 北 七筒 北 南 七筒 北 七筒 一条 二条 一条 二条 南 一条 北
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 冬 秋

- 结算逐笔明细（谁付给谁、倍率和金额）
  - [自摸] AI-AK -> AI-老赵 : 0 (0x4)
  - [自摸] AI-小胖 -> AI-老赵 : 0 (0x4)
  - [自摸] AI-阿水 -> AI-老赵 : 0 (0x4)