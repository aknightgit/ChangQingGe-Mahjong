...
### 第1轮 (强度=1.0, 停滞=0)
  ...
  C2: fitness=-84491 hu=4% self=25% disc=75% draws=96
  C3: fitness=-87616 hu=1% self=100% disc=0% draws=99
  C4: fitness=-86416 hu=2% self=50% disc=50% draws=98
  C5: fitness=-84566 hu=4% self=0% disc=100% draws=96
  ★ NEW BEST! fitness=-84491
  指标: hu=4% self=25% disc=75% big=0% mq=100%

## Round 1 (2026-04-08T11:00:06.351Z)
...
```json
{
  ...
  "discardHuMenQingPenalty": 0.13636692099953446,
  "pengChance": 1,
  ...
  "allHonorsPursuit": 0.15508770975623482,
  ...
  "wild3RouteHonorsBoost": 0.3410094218826013,
  ...
  "hand6RouteBias": 0.549900080225494,
  "hand7RouteBias": 0.9,
