---
创建时间: 2026-04-08T14:57:41.529Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 1 games = 1 total
---

## Round 1 (2026-04-08 14:57:41)
...
**局次0**（放冲 · ×2）
  - AI-老赵: 普通 ·  · 碰:八筒 八筒 八筒; 碰:发 发 发; 碰:一条 一条 一条 → 140点
  - AI-AK: 普通 ·  · 碰:白 白 白; 碰:七万 七万 七万 → 100点
  - AI-小胖: 普通 ·  · 碰:西 西 西; 碰:五万 五万 五万 二万 二万 二万 → 100点
...
```json
{
  ...
  "wild2BaoPush": 0.21052271925132762,
  "wild3BaoPush": 0.8,
  "multLowSpeedBias": 0.436043385362001,
  "multHighValueBias": 0.7829166927551453,
  "discardObsFlushBoost": 0.3110395469495198,
  "discardObsWeight": 0.24157831324559054,
