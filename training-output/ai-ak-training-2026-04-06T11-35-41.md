...
## 基线成绩（第0轮）
AI-AK baseline: score=0  wins=0/100  draws=100
### 第1轮 (强度=1.0, 停滞=0)
  Candidate 1: score=0  wins=0/100 (0.0%)  draws=99
  Candidate 2: score=0  wins=0/100 (0.0%)  draws=100
  Candidate 3: score=0  wins=0/100 (0.0%)  draws=100
  Candidate 4: score=0  wins=0/100 (0.0%)  draws=100
  Best this round: 0  (overall best: 0)  [plateau: 1]
  Current standings: AI-AK:0(0%)  AI-小胖:0(0%)  AI-阿水:0(0%)  AI-老赵:0(0%)

## Round 1 (2026-04-06T11:35:44.770Z)
...
```json
{
  ...
  "discardHuWildPenalty": 0.3816860674069351,
  ...
  "sequenceVsTripletBias": 0.048678544386906025,
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-老赵
    - 胡牌方式: 自摸
    - 手牌牌面: 六条 八万 六条 一万 八万 八万 一万 二筒 一万 二万 六条 二万 二筒 八万
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 兰
...
[性能] canWin缓存: 命中20 未命中84 命中率19.2%
