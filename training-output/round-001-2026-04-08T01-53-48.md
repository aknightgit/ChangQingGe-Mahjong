---
创建时间: 2026-04-08T01:53:48.596Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 10 games = 10 total
---

## Round 1 (2026-04-08 01:53:48)
...
**每局获胜人数分布**（本轮所有胡牌局）
- 单人胡牌: 1局 | 双人胡牌: 0局 | 三人胡牌: 0局 | 四人胡牌: 0局
...
**局次4**（自摸 · ×1）
  - AI-AK: 普通 · 五筒 五筒 六筒 四筒 四条 六筒 四条 六筒 · 碰:白 白 白; 碰:一万 一万 一万 → 70点
...
```json
{
  ...
  "discardHuChance": 0.7,
  "selfWinWildBoost": 0.12371089103185344,
  "discardHuWildPenalty": 0.31580513879396227,
  "discardHuMenQingPenalty": 0.11443176185539769,
  "pengChance": 1,
  "kongChance": 0.5083624614752444,
  "chowChance": 0.35,
  ...
  "meldPenalty": 0.0058348755748543445,
  ...
  "wild1RouteFlushBoost": 0.3294787912234889,
...
**胡牌玩家明细：**
  - 玩家: AI-AK
    - 胡牌方式: 自摸
    - 牌型/基础番/最终点: 普通 / 7 / 70
    - 手牌牌面: 五筒 五筒 六筒 四筒 四条 六筒 四条 六筒
    - 门口牌（吃/碰/杠）: 碰:白 白 白 ; 碰:一万 一万 一万
    - 花牌: 春 菊 竹
**结算逐笔明细：**
  - [自摸] AI-小胖 -> AI-AK : 70 (7×10×1)
  - [自摸] AI-阿水 -> AI-AK : 70 (7×10×1)
  - [自摸] AI-老赵 -> AI-AK : 70 (7×10×1)
