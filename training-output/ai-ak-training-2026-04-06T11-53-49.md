...
## 基线成绩（第0轮）
AI-AK baseline: score=0  wins=0/30  draws=30
### 第1轮 (强度=1.0, 停滞=0)
  Candidate 1: score=0  wins=0/30 (0.0%)  draws=30
  Candidate 2: score=0  wins=0/30 (0.0%)  draws=30
  Candidate 3: score=0  wins=0/30 (0.0%)  draws=30
  Candidate 4: score=0  wins=0/30 (0.0%)  draws=30
  Best this round: 0  (overall best: 0)  [plateau: 1]
  Current standings: AI-AK:0(0%)  AI-小胖:0(0%)  AI-阿水:0(0%)  AI-老赵:0(0%)

## Round 1 (2026-04-06T11:53:50.460Z)
...
```json
{
  ...
  "chowWildPenalty": 0.20548231364457636,
  ...
  "wallLateDefense": 0.8594390801972931,
  ...
  "speedVsValueBalance": 0.4481986758459647,
...
[性能] canWin缓存: 命中14 未命中126 命中率10.0%
