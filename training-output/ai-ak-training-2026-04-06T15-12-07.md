...
| 流局率 | 100.0% | | |
### 第1轮 (强度=1.0, 停滞=0)
  Candidate 1: fitness=-1543.0  draws=3(100%)  selfDraw=0%
  Candidate 2: fitness=-1543.0  draws=3(100%)  selfDraw=0%
  Candidate 3: fitness=-1543.0  draws=3(100%)  selfDraw=0%
  Candidate 4: fitness=-1543.0  draws=3(100%)  selfDraw=0%
  Best this round: -1543  (overall best: -1543)  [plateau: 1]
  Current standings: AI-AK:0(0%)  AI-小胖:0(0%)  AI-阿水:0(0%)  AI-老赵:0(0%)

## Round 1 (2026-04-06T15:12:08.246Z)
...
```json
{
  ...
  "halfFlushWeight": 0.589505563184096,
  ...
  "multLowHand7HalfFlush": 0.38156491900145983,
  ...
  "minkanAggression": 0.4331030803826373,
...
[性能] isTing缓存: 命中76 未命中1416 命中率5.1%
[性能] canWin缓存: 命中24 未命中1365 命中率1.7%
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-小胖
    - 胡牌方式: 自摸
    - 手牌牌面: 九万 四万 九万 三条 二万 四万 三条 二万 三条 四万 九万 八万 八万 三条
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 菊
