---
创建时间: 2026-04-08T13:14:54.643Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 1 games = 1 total
---

## Round 1 (2026-04-08 13:14:54)
...
**局次0**（放冲 · ×1）
  - AI-AK: 普通 ·  · 碰:五万 五万 五万 → 80点
  - AI-老赵: 普通 ·  · 碰:三筒 三筒 三筒; 碰:六条 六条 六条; 杠:三条 三条 三条 三条 → 30点
  - AI-小胖: 普通 ·  · 碰:二筒 二筒 二筒 一筒 一筒 一筒 → 200点
...
```json
{
  ...
  "meldPenalty": 0.05712194771468891,
  ...
  "wallEarlySpeedPush": 0.285209473447759,
  "wallMidBalance": 0.4405118254914803,
  "wallLateDefense": 0.893722782470017,
...
**胡牌玩家明细：**
  - 玩家: AI-小胖
    - 胡牌方式: 放冲
    - 牌型/基础番/最终点: — / 8 / 80
    - 手牌牌面: 八筒 七筒 南 五筒 五筒 七筒 八筒 五筒 二筒 二筒 二筒 一筒 一筒 一筒
    - 门口牌（吃/碰/杠）: 碰:二筒 二筒 二筒 ; 碰:一筒 一筒 一筒
    - 花牌: 冬 夏 秋
**结算逐笔明细：**
  - [放炮] AI-老赵 -> AI-AK : 80 (8×10×1)
