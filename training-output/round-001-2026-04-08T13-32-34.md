---
创建时间: 2026-04-08T13:32:34.801Z
训练脚本: train-ai-ak.ts
Config: 1 rounds × 20 games = 20 total
---

## Round 1 (2026-04-08 13:32:34)
...
**每局获胜人数分布**（本轮所有胡牌局）
- 单人胡牌: 0局 | 双人胡牌: 0局 | 三人胡牌: 3局 | 四人胡牌: 0局
- 多人胡牌率: 100.0%（目标>80%时血战才有意义）
...
**局次0**（放冲 · ×1）
  - AI-AK: 普通 ·  · 碰:四筒 四筒 四筒; 顺:六筒 七筒 八筒 五筒 六筒 七筒 → 100点
  - AI-老赵: 普通 ·  · 碰:白 白 白; 碰:九条 九条 九条 → 70点
  - AI-阿水: 普通 ·  · 碰:一条 一条 一条 六条 六条 六条; 碰:八万 八万 八万 → 40点
**局次6**（放冲 · ×2）
  - AI-阿水: 普通 ·  · 碰:七筒 七筒 七筒; 碰:九条 九条 九条 → 60点
  - AI-老赵: 普通 ·  · 碰:六筒 六筒 六筒; 碰:二万 二万 二万 → 90点
  - AI-AK: 普通 ·  · 碰:八筒 八筒 八筒; 碰:一条 一条 一条; 杠:二条 二条 二条 二条 → 40点
**局次17**（放冲 · ×2）
  - AI-小胖: 普通 ·  · 碰:一筒 一筒 一筒; 碰:九万 九万 九万 八万 八万 八万 → 30点
  - AI-AK: 普通 ·  · 碰:七筒 七筒 七筒 → 40点
  - AI-老赵: 普通 ·  · 杠:北 北 北 北; 碰:四条 四条 四条; 碰:二万 二万 二万 → 70点
...
```json
{
  ...
  "allHonorsPungsPursuit": 0.08804391643146618,
  "qingPengPursuit": 0.533487758280637,
  "hunPengPursuit": 0.5442411827354836,
  "windEastKeep": 1.7663111765725783,
  "windSouthKeep": 2.499702045690308,
  ...
  "dragonGeneralKeep": 1.566248005956021,
  ...
  "wild3RouteMeldPush": 0.8048246127397971,
  ...
  "wild3RouteHonorsBoost": 0.40238290881094835,
  ...
  "wildMultHighAggression": 0.702000564760552,
  ...
  "wild3BaoPush": 0.8167394683812277,
  "multLowSpeedBias": 0.5,
  "multHighValueBias": 0.7918561370314691,
  ...
  "multLowHand7AllPungs": 0.2234155012135569,
  "multLowHand7HalfFlush": 0.38968039017425526,
  ...
  "defenseRiskAversion": 0.44190442347146613,
  "wallTilesImpact": 0.21662568308121116,
  "baoRiskAversion": 0.6174292204162568,
  "baoThreshold": 4,
  "anKongAggression": 0.9564908137617628,
  "minkanAggression": 0.3782679008281927,
  "kakanAggression": 0.4100380459711165,
  "robKongAwareness": 0.46233726832938465,
  "noWildDoubleAwareness": 0.44641326791251484,
  "menqingDoubleAwareness": 0.5678003159797125,
  "flushVsPungsBalance": 0.1,
  "honorVsSuitedBalance": -0.06499699959801614,
  "sequenceVsTripletBias": 0.17767153160359095,
...
**胡牌玩家明细：**
  - 玩家: AI-AK
    - 胡牌方式: 自摸
    - 牌型/基础番/最终点: — / 4 / 40
    - 手牌牌面: 四条 东 东 五条 东 一条 一条 一条 二条 二条 二条 二条 八筒 八筒 八筒
    - 门口牌（吃/碰/杠）: 碰:一条 一条 一条 ; 杠:二条 二条 二条 二条 ; 碰:八筒 八筒 八筒
    - 花牌: 竹
**结算逐笔明细：**
  - [放炮] AI-老赵 -> AI-阿水 : 120 (6×10×2)
  - [放炮] AI-小胖 -> AI-老赵 : 180 (9×10×2)
  - [自摸] AI-小胖 -> AI-AK : 80 (4×10×2)
  - [自摸] AI-阿水 -> AI-AK : 80 (4×10×2)
  - [自摸] AI-老赵 -> AI-AK : 80 (4×10×2)
