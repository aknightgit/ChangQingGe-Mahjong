...
## Round 1 (2026-04-06T15:09:29.640Z)
...
```json
{
  ...
  "oppTingDetection": 0.5068198816854077,
  ...
  "hand6RouteBias": 0.6,
  "hand7RouteBias": 0.9605028839719608,
  ...
  "multHighHand7HalfFlush": 0.46470554901711497,
  ...
  "wallTilesImpact": 0.16143876830073917,
  "baoRiskAversion": 0.6174292204162568,
  "baoThreshold": 4,
  "anKongAggression": 0.9564908137617628,
  "minkanAggression": 0.3782679008281927,
  "kakanAggression": 0.39954289475202365,
  "robKongAwareness": 0.5414733926547664,
...
[性能] isTing缓存: 命中60 未命中1433 命中率4.0%
[性能] canWin缓存: 命中4 未命中298 命中率1.3%
...
- 输出该局所有胡牌玩家明细
  - 玩家: AI-小胖
    - 胡牌方式: 胡牌
    - 手牌牌面: 六条 六万 九万 八万 九万 五万 六条 六条 八万 六万 六万 八万 五万
    - 门口牌（吃/碰/杠）: (无)
    - 花牌: 夏

- 结算逐笔明细（谁付给谁、倍率和金额）
  - [放炮] AI-阿水 -> AI-小胖 : 0 (0x2)