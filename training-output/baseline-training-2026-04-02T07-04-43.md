...
### 第1轮 (强度=1.0, 停滞=0)
  C1: fitness=-2563 hu=0% self=0% disc=0% draws=20
  C2: fitness=-2054 hu=15% self=33% disc=67% draws=17
  C3: fitness=-1996 hu=15% self=33% disc=67% draws=17
  C4: fitness=-2563 hu=0% self=0% disc=0% draws=20
  C5: fitness=-2463 hu=5% self=0% disc=100% draws=19
  ★ NEW BEST! fitness=-1996
  指标: hu=15% self=33% disc=67% big=0% mq=0%

## Round 1 (2026-04-02T07:04:49.717Z)
