...
### 第1轮 (强度=1.0, 停滞=0)
  C1: fitness=-1440 hu=4% self=25% disc=75% draws=480
  C2: fitness=-1378 hu=3% self=29% disc=71% draws=486
  C3: fitness=-1514 hu=4% self=17% disc=83% draws=482
  C4: fitness=-1515 hu=3% self=13% disc=88% draws=484
  C5: fitness=-1395 hu=6% self=25% disc=75% draws=472
  Best: -1378 (overall: -1343) [plateau: 1]
  指标: hu=3% self=29% disc=71% big=0% mq=7%

## Round 1 (2026-04-01T13:38:13.172Z)
...
```json
{
  ...
  "dragonGreenKeep": 3,
  "dragonWhiteKeep": 3.5109945015282507,
  ...
  "wild3RouteMeldPush": 0.8884973353968981,
